    ...
    <section className="section text-center container" style={{ padding: '160px 0' }}>
      <FadeIn>
        ...
        <div className="flex justify-center gap-md">
          <a href="/dashboard/login" className="btn btn-primary" style={{ padding: '16px 32px', fontSize: '16px' }}>Start Free</a>
          <a href="/dashboard/login" className="btn btn-ghost" style={{ padding: '16px 32px', fontSize: '16px' }}>Talk to Sales</a>
        </div>
      </FadeIn>
    </section>
  );
